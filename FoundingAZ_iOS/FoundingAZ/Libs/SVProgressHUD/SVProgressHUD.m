...
+ (SVProgressHUD*)sharedView {
    ...
    dispatch_once(&once, ^{ sharedView = [[self alloc] initWithFrame:[[[UIApplication sharedApplication] delegate] window].bounds];
        sharedView.defaultStyle = SVProgressHUDStyleCustom;
        sharedView.foregroundColor = [UIColor whiteColor];
        sharedView.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:.8f];
        [sharedView setDefaultMaskType:SVProgressHUDMaskTypeBlack];
    });
#else
